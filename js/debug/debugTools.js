class DebugTools {
    ...
    createCharacterDebugPanel(){
        ...
        const heros = [
            ...
            { hero: ZhugeLiang, name: "จูกัดเหลียง"}, 
            { hero: HuangGai, name: "อุยกาย"}, 
            { hero: HuaXiong, name: "ฮัวหยง"}, 
            { hero: XuZhu, name: "เคาทู"}, 
            { hero: ZhaoYun, name: "จูล่ง"}, 
            { hero: ZhouYu, name: "จิวยี่"}, 
            { hero: GongsunZan, name: "กองซุนจ้าน"}, 
            { hero: GuoJia, name: "กุยแก"}, 
            { hero: MaChao, name: "ม้าเฉียว"}, 
            { hero: DaQiao, name: "ไต้เกี้ยว"}, 
            { hero: PanFeng, name: "พัวฮอง"}, 
            ...
            { hero: SunShangxiang, name: "ซุนซ่างเซียง"}
